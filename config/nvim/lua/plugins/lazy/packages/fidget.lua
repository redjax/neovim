...
return {
  ...
  -- plugin options provided as a table to setup()
  opts = {
    progress = {
      poll_rate = 0,
      suppress_on_insert = false, -- How and when to poll for progress messages
  ...
  config = function(_, opts)
    -- Move any requires of internal plugin modules here
    opts.notification.configs = { default = require("fidget.notification").default_config }
