...
local theme_menu_items = {
    ...
    theme("Ayu", "ayu", "ayu"),
    theme("Bluloco Dark", "bluloco-dark", "bluloco.nvim"),
    theme("Bluloco Light", "bluloco-light", "bluloco.nvim"),
    ...
    theme("Moonfly", "moonfly", "vim-moonfly-colors"),
    theme("Modus Operandi", "modus_operandi", "modus-themes.nvim"),
    theme("Modus Vivendi", "modus_vivendi", "modus-themes.nvim"),
    ...
    theme("Nightfox", "nightfox", "nightfox.nvim"),
    theme("Carbonfox", "carbonfox", "nightfox.nvim"),
    theme("Dawnfox", "dawnfox", "nightfox.nvim"),
    theme("Dayfox", "dayfox", "nightfox.nvim"),
    theme("Duskfox", "duskfox", "nightfox.nvim"),
    theme("Nordfox", "nordfox", "nightfox.nvim"),
    theme("Terafox", "terafox", "nightfox.nvim"),
    theme("Rusty", "rusty", "rusty"),
